...
export default function ImportSimulator() {
  ...
  return (
    <section className="py-16 lg:h-screen lg:snap-start lg:flex lg:flex-col lg:justify-center lg:py-0 bg-neutral-900 text-white relative overflow-hidden border-y border-neutral-800">
