      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex justify-between items-center mb-1">
            <span className="font-sans text-[10px] font-bold text-accent-gold tracking-widest uppercase">
              {car.brand}
            </span>
            {car.power && (
              <span className="text-[10px] font-semibold text-neutral-500 font-sans">
                {car.power} CV
              </span>
            )}
          </div>
          ...
          {/* Modelo */}
          <h3 className="font-serif text-lg font-normal text-neutral-900 leading-snug group-hover:text-accent-gold transition-colors duration-200 mb-3 min-h-[44px] flex items-start">
            {car.model}
          </h3>
          ...
          <div className="grid grid-cols-2 gap-y-2 border-t border-neutral-100 pt-3 pb-4">
            <div className="flex items-center space-x-2 text-neutral-500">
              ...
              <span className="font-sans text-xs font-semibold text-neutral-600">{car.year}</span>
            </div>
            <div className="flex items-center space-x-2 text-neutral-500">
              <Gauge className="w-3.5 h-3.5 text-neutral-400" />
              <span className="font-sans text-xs font-semibold text-neutral-600">
        ...
        <div className="border-t border-neutral-100 pt-4 flex items-center justify-between mt-auto">
          ...
          <Link
            ...
            className="cursor-pointer inline-flex items-center space-x-1.5 font-sans text-[10px] font-bold uppercase tracking-wider border border-neutral-200 group-hover:border-neutral-900 group-hover:bg-neutral-950 group-hover:text-white px-3 py-2 rounded-lg transition-all duration-300"
          >
            <span>Ver Ficha</span>
          </Link>
        </div>
